        ...
        <div class="navbar-nav theme-brand flex-row  text-center">
            <div class="nav-logo">
                <div class="nav-item theme-logo">
                    <a href="./index.html">
                        <img src="../src/assets/logo.svg" class="navbar-logo" alt="logo">
                    </a>
                </div>
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="users" data-bs-parent="#accordionExample">
                    <li>
                        <a href="/user/create"> Add Employee </a>
                    </li>
                    <li>
                        <a href="/user"> Employees List </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="students" data-bs-parent="#accordionExample">
                    <li>
                        <a href="/user/create"> Add Student </a>
                    </li>
                    <li>
                        <a href="/user"> Students List </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="roles" data-bs-parent="#accordionExample">
                    <li>
                        <a href="/user/create"> Add Role </a>
                    </li>
                    <li>
                        <a href="/user"> Roles List </a>
                    </li>
                </ul>
            </li>
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="branches" data-bs-parent="#accordionExample">
                    <li>
                        <a href="/user/create"> Add Branch </a>
                    </li>
                    <li>
                        <a href="/user"> Branchs List </a>
                    </li>
                </ul>
            </li>
            <li class="menu menu-heading">
            ...
            <li class="menu">
                <a href="#attandance" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                ...
                <ul class="collapse submenu list-unstyled" id="attandance" data-bs-parent="#accordionExample">
                    <li>
                        <a href="/user/create"> Start Attandance </a>
                    </li>
                    <li>
                        <a href="/user"> Employee Attandance List </a>
                    </li>
                    <li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="education" data-bs-parent="#accordionExample">
                    <li>
                        <a href="/user/create"> Add Course </a>
                    </li>
                    <li>
                        <a href="/user"> Course List </a>
                    </li>
                    <li>
