...
class User extends Authenticatable
{
    ...
    /**
     * Get all of the proposalForItem for the User
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     */
    public function proposalForItem(): HasMany
    {
        return $this->hasMany(ProposalForItem::class);
    }

    /**
     * Get the userEducation that owns the User
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    public function userEducation(): BelongsTo
    {
